...
/* Define to 1 if you have the declaration of `UCT_CB_FLAG_SYNC', and to 0 if
   you don't. */
#define HAVE_DECL_UCT_CB_FLAG_SYNC 1

/* Define to 1 if you have the declaration of `UCT_PROGRESS_THREAD_SAFE', and
   to 0 if you don't. */
#define HAVE_DECL_UCT_PROGRESS_THREAD_SAFE 1
...
#define MCA_io_romio321_COMPLETE_CONFIGURE_FLAGS " FROM_OMPI=yes CC='gcc -std=gnu99 -std=gnu99' CFLAGS='-O3 -DNDEBUG -finline-functions -fno-strict-aliasing -mcx16 -pthread -D__EXTENSIONS__' CPPFLAGS='-I/tc/xfr/openmpi/openmpi-4.0.2/opal/mca/event/libevent2022/libevent -I/tc/xfr/openmpi/openmpi-4.0.2/opal/mca/event/libevent2022/libevent/include -I/tc/xfr/openmpi/openmpi-4.0.2/opal/mca/hwloc/hwloc201/hwloc/include  ' FFLAGS='' LDFLAGS=' ' --enable-shared --disable-static  --prefix=/usr/local --disable-aio --disable-weak-symbols --enable-strict --disable-f77 --disable-f90"
...
#define OMPI_TARBALL_VERSION "4.0.2"
...
#define OPAL_IDENT_STRING "4.0.2"
...
#define OPAL_PACKAGE_STRING "Open MPI sts@tc0 Distribution"
...
#define OPAL_RELEASE_DATE "Oct 07, 2019"
...
#define OPAL_TARBALL_VERSION "4.0.2"
...
#define ORTE_RELEASE_DATE "Oct 07, 2019"
...
#define OSHMEM_TARBALL_VERSION "4.0.2"
...
#define PACKAGE_STRING "Open MPI 4.0.2"
